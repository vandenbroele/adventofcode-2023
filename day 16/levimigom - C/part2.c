...
int count_energized_tiles(char **contraption, int rows, int cols, int row, int col, enum Direction direction, bool ***visited){
	int i, j, k, energized_count;
	...
	mark_energized_tiles(contraption, rows, cols, row, col, direction, visited);
...
void solve(){
	int rows, cols, i, j, max_energized_count;
	...
	// find the maximum amount of energized tiles possible
	max_energized_count = 0;
	for(i = 0; i < rows; i++){
		max_energized_count = max(max_energized_count, count_energized_tiles(contraption, rows, cols, i, 0, East, visited));
		max_energized_count = max(max_energized_count, count_energized_tiles(contraption, rows, cols, i, cols - 1, West, visited));
	}
	
	for(i = 0; i < cols; i++){
		max_energized_count = max(max_energized_count, count_energized_tiles(contraption, rows, cols, 0, i, South, visited));
		max_energized_count = max(max_energized_count, count_energized_tiles(contraption, rows, cols, rows - 1, i, North, visited));
	}
